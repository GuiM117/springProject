...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), u1, OrderStatus.WAITING_PAYMENT); // z -> UTC timezone
		...
		p1.getCategories().add(cat2);				// Associate categories to a product
		...
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));		//save again with associations
		
		OrderItem oi1 = new OrderItem(o1, p1, 2, p1.getPrice());	// Item order, associating Product with Order
